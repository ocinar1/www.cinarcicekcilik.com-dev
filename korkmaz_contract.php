<?php
	 ...
	 * Description:       Woocommerce eklentisi için ödeme sayfasında sözleşme göstermeye,oluşturmaya ve pdf olarak mail göndermeye yarayan eklenti.
	 * Version:           1.3.3
	...
	define ( 'KORKMAZ_CONTRACT_VERSION','1.3.3' );
