...
class Korkmaz_contract_Public
{
	...
	/*
	 * 1.3.3 sürümü ile düzenlendi
	 * sözleşmeler orderdan değil postmetadan alındı
	 * html etiketlerini order meta siliyor.
	 * */
	public function pdf_url($order_id, $ismi, $sozlesmeadi)
	{
		$korkmaz_mail_fonksiyon = new korkmaz_contract_dompdf();
		$birinci_sozlesme_metin = $this->pdf_metni_hazirla(get_post_meta($order_id, $ismi, true));
